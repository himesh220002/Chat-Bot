...
export default function ModelIntelDashboard() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[#090d12] text-[#ece8e1] font-mono select-none">
      ...
      <div className="flex-1 overflow-y-auto px-3.5 py-2 space-y-3.5 scrollbar-thin">
        {CATEGORIES.map((cat) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between pl-2 mb-2">
                <span className={`text-[11px] font-extrabold tracking-[0.16em] ${cat.textAccent}`}>
                  {cat.label}
                </span>
                ...
                {top3.map((item, idx) => {
                  ...
                  return (
                    <div key={item.key || idx} className="text-[10px]">
                      ...
                      {/* Dual Bar Graph (Speed / Score) */}
                      <div className="space-y-0.5">
                        {/* Speed Bar */}
                        <div className="h-1 bg-[#16202c] overflow-hidden rounded-xs flex">
                          <div
                            className={`h-full ${cat.barSpeed} transition-all duration-500`}
                        ...
                        <div className="h-1 bg-[#16202c] overflow-hidden rounded-xs flex">
                          <div
                            className="h-full bg-[#ff4655]/70 transition-all duration-500"
